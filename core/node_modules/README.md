You can put any app-specific Node.js modules in this directory. They will be made accessible for importing by the default lightweight-httpd.mv and lightweight-processor.mv
