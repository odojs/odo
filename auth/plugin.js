...
(function() {
  ...
  define(['module', 'passport', 'odo/infra/config', 'redis', 'odo/projections/userprofile', 'odo/infra/hub', 'node-uuid'], function(module, passport, config, redis, UserProfile, hub, uuid) {
    var Auth, db;
